...
describe('MCP Analytics Server', () => {
    ...
    describe('POST /tools/call', () => {
        it('should execute getListingMetrics successfully', async () => {
            ...
            analytics_1.getListingMetrics.mockResolvedValueOnce(mockMetrics);
            const response = await app.inject({
                method: 'POST',
                url: '/tools/call',
                payload: {
            ...
            expect(analytics_1.getListingMetrics).toHaveBeenCalledWith(['L001']);
        });
        it('should execute getMarketAnalysis successfully', async () => {
            ...
            analytics_1.getMarketAnalysis.mockResolvedValueOnce(mockAnalysis);
            const response = await app.inject({
                method: 'POST',
                url: '/tools/call',
                payload: {
            ...
            expect(analytics_1.getMarketAnalysis).toHaveBeenCalledWith('Portland, OR');
        });
        it('should execute generatePerformanceReport successfully', async () => {
            ...
            analytics_1.generatePerformanceReport.mockResolvedValueOnce(mockReport);
            const response = await app.inject({
                method: 'POST',
                url: '/tools/call',
                payload: {
        ...
        it('should handle tool execution errors', async () => {
            analytics_1.getListingMetrics.mockRejectedValueOnce(new Error('Analytics database unavailable'));
            const response = await app.inject({
                method: 'POST',
                url: '/tools/call',
                payload: {
        ...
        it('should validate required arguments', async () => {
            ...
            expect(analytics_1.getMarketAnalysis).toHaveBeenCalledWith(undefined);
        });
    });
    describe('GET /health', () => {
