import { ListingMetrics, MarketAnalysis } from '@llm-tools/shared-types';

export const mockListingMetrics: ListingMetrics[] = [
  {
    listingId: 'L001',
    pageViews: 1250,
    saves: 45,
...
export const mockMarketAnalysis: Record<string, MarketAnalysis> = {
  'Portland, OR': {
    area: 'Portland, OR',
    averagePrice: 785000,
    priceChange: 8.5,
