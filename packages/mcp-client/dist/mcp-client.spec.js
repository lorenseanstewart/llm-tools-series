...
describe('MCPClient', () => {
    ...
    beforeEach(() => {
        client = new mcp_client_1.MCPClient({ baseURL, timeout: 5000, retries: 3 });
        jest.clearAllMocks();
    });
    afterEach(() => {
        jest.clearAllTimers();
    ...
    describe('authentication', () => {
        it('should create client with auth token', () => {
            const clientWithAuth = new mcp_client_1.MCPClient({
                baseURL,
                timeout: 5000,
                retries: 3,
        ...
        it('should call interceptor when creating client', () => {
            ...
            jest.clearAllMocks();
            const newClient = new mcp_client_1.MCPClient({
